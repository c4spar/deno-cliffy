...
export { describe, it } from "https://deno.land/std@0.158.0/testing/bdd.ts";
export {
  bold,
  red,
  stripColor,
} from "https://deno.land/std@0.158.0/fmt/colors.ts";
export { dirname } from "https://deno.land/std@0.158.0/path/mod.ts";
export { expandGlob } from "https://deno.land/std@0.158.0/fs/mod.ts";

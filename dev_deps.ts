...
export { dirname } from "https://deno.land/std@0.136.0/path/mod.ts";
export { expandGlob } from "https://deno.land/std@0.136.0/fs/mod.ts";
export type { WalkEntry } from "https://deno.land/std@0.136.0/fs/mod.ts";

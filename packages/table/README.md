...
```typescript
import { Table } from 'https://deno.land/x/cliffy@<version>/table.ts';
```

Nest Registry

```typescript
import { Table } from 'https://x.nest.land/cliffy@<version>/table.ts';
```

Github

```typescript
import { Table } from 'https://raw.githubusercontent.com/c4spar/deno-cliffy/<version>/table.ts';
```
...
![](../../assets/img/table/basic-usage.png)
...
![](../../assets/img/table/using-as-array.png)
...
![](../../assets/img/table/header-and-body.png)
...
![](../../assets/img/table/table-options.png)
...
![](../../assets/img/table/rows-and-cells.png)
...
![](../../assets/img/table/colspan-and-rowspan.png)
